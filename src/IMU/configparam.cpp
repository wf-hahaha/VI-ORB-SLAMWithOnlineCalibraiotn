...
//syl***add for Rbc change
void ConfigParam::SetRbc(Eigen::Matrix3d Rbc)
{
  _EigTbc(0,0)=Rbc(0,0);
  _EigTbc(0,1)=Rbc(0,1);
  _EigTbc(0,2)=Rbc(0,2);
  ...
  Eigen::Matrix3d Rcb=Rbc.inverse();
  _EigTcb(0,0)=Rcb(0,0);
  _EigTcb(0,1)=Rcb(0,1);
  _EigTcb(0,2)=Rcb(0,2);
  _EigTcb(1,0)=Rcb(1,0);
  ...
  _MatTbc.at<float>(0,0)=Rbc(0,0);
  _MatTbc.at<float>(0,1)=Rbc(0,1);
  _MatTbc.at<float>(0,2)=Rbc(0,2);
  _MatTbc.at<float>(1,0)=Rbc(1,0);
  _MatTbc.at<float>(1,1)=Rbc(1,1);
  _MatTbc.at<float>(1,2)=Rbc(1,2);
  _MatTbc.at<float>(2,0)=Rbc(2,0);
  _MatTbc.at<float>(2,1)=Rbc(2,1);
  _MatTbc.at<float>(2,2)=Rbc(2,2);
  
  _MatTcb.at<float>(0,0)=Rcb(0,0);
  _MatTcb.at<float>(0,1)=Rcb(0,1);
  _MatTcb.at<float>(0,2)=Rcb(0,2);
  _MatTcb.at<float>(1,0)=Rcb(1,0);
  _MatTcb.at<float>(1,1)=Rcb(1,1);
  _MatTcb.at<float>(1,2)=Rcb(1,2);
  _MatTcb.at<float>(2,0)=Rcb(2,0);
  _MatTcb.at<float>(2,1)=Rcb(2,1);
  _MatTcb.at<float>(2,2)=Rcb(2,2);
}

void ConfigParam::SetPcb(cv::Mat Pcb)
{
  cv::Mat Pbc=-_MatTbc.rowRange(0,3).colRange(0,3)*Pcb;
  _MatTbc.at<float>(0,3)=Pbc.at<float>(0,0);
  _MatTbc.at<float>(1,3)=Pbc.at<float>(1,0);
  _MatTbc.at<float>(2,3)=Pbc.at<float>(2,0);
  
  _EigTbc(0,3)=Pbc.at<float>(0,0);
  _EigTbc(1,3)=Pbc.at<float>(1,0);
  _EigTbc(2,3)=Pbc.at<float>(2,0); 
   
  _MatTcb.at<float>(0,3)=Pcb.at<float>(0,0);
  _MatTcb.at<float>(1,3)=Pcb.at<float>(1,0);
  _MatTcb.at<float>(2,3)=Pcb.at<float>(2,0);
  
  _EigTcb(0,3)=Pcb.at<float>(0,0);
  _EigTcb(1,3)=Pcb.at<float>(1,0);
  _EigTcb(2,3)=Pcb.at<float>(2,0);  
