...
protected:
    ...
    //add for TryInitVIOWithoutPreCalibration
public:
  ...
  bool CheckVIRotationConvergence(int Nwin,float thr);
  bool CheckPcbConvergence(int Nwin,float thr);
  bool CheckScaleConvergence(int Nwin,float thr);
