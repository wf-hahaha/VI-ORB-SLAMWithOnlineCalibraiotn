...
//          break;
    ...
    delete [] fullPath;
    SLAM.SaveTrajectoryTUM(config._tmpFilePath +argv[6]+ "_MonoVI.txt");
    SLAM.SaveKeyFrameTrajectoryNavState(config._tmpFilePath +argv[6]+ "Keyframe_MonoVI.txt"); // from body(IMU) to world.
